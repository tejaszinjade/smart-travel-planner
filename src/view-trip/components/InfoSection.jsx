            ...
            <div className='flex justify-between items-center'>
                <div className='mhy-5 flex flex-col gap-2'>
                    ...
                    <div className='flex gap-5'>
                        <h2 className='p-1 px-3 bg-gray-200 rounded-full text-gray-600 text-xs md:text-md'>📅 {trip.userSelection?.noOfDays} Day</h2>
                        <h2 className='p-1 px-3 bg-gray-200 rounded-full text-gray-600 text-xs md:text-md'>💸 {trip.userSelection?.budget} Budget</h2>
                        <h2 className='p-1 px-3 bg-gray-200 rounded-full text-gray-600 text-xs md:text-md'>🥂 No. Of Traveller: {trip.userSelection?.traveler}</h2>
                    </div>
